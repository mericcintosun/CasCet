...
| **Cep18X402** *(third-party, deployed for interop)* | Reference `transfer_with_authorization` (EIP-3009) token from [make-software/casper-x402](https://github.com/make-software/casper-x402); lets a facilitator settle real x402 payments. Not authored by CasCet (see `NOTICE`). | `hash-cb65a928f8e1b7ce172bddd075c10dd0de8bcfd9cf808c799fd409766a1735c3` |
...
| 3 | **Real x402 settlement** — agent pays a real CEP-18 `transfer_with_authorization`; a self-hosted x402 facilitator verifies and settles (no mock). | [`0218ff4c…`](https://testnet.cspr.live/transaction/0218ff4c8d726a610a7a02168cd24941d4db07a9ca787c2fa6f89f21ac159ce7) |
